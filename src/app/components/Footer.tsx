    ...
    <footer className="bg-black border-t border-gray-700 text-white pt-10 px-6 md:px-10 lg:px-20">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="border border-dashed p-4 flex gap-5 items-start md:w-1/2 lg:w-1/3"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="grid grid-cols-2 sm:grid-cols-3 gap-10 md:gap-14 md:w-1/2 lg:w-2/3"
        >
          <div>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.5 }}
        className="mt-10 mb-4 text-sm flex flex-col md:flex-row justify-between items-center gap-4"
      >
